...
data1<-readRDS("tds_final_group_1/result_data/combined_nutrition_code.rds")
confounder<-data1[,c("eid","sex","age")]
saveRDS(confounder,"tds_final_group_1/result_data/confounder.rds")
covars=readRDS("tds_final_group_1/result_data/confounder.rds")
...
write.table(mymodel, "tds_final_group_1/result_data/confounders.txt", row.names=FALSE, col.names=TRUE, quote=FALSE, sep=" ")
