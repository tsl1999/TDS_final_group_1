...
merged<- readRDS("tds_final_group_1/result_data/cate_merge_disease(final).rds")
...
saveRDS(merged_no_withdraw,"tds_final_group_1/result_data/merged_no_withdraw.rds")


#outcome of interest remove withdrawn---------------------------------------------
disease_outcome<-readRDS("tds_final_group_1/result_data/disease_outcomes.rds")
...
saveRDS(merge_disease,"tds_final_group_1/result_data/combined_data.rds")
#subset data-------------------------------------------------------
